...
|----- |------------ |-------- |-------- |------------- |
| [atuin](https://atuin.sh) | Magical shell history | 18.15.2 | 2026-04-17 | mcfly, hishtory |
...
| [code-server](https://coder.com) | VS Code in the browser | 4.117.0 | 2026-04-24 |  |
...
| [dasel](https://github.com/TomWright/dasel) | Select, put and delete data from JSON, TOML, YAML, XML and CSV files with a single tool. Supports conversion between formats and can be used as a Go package. | 3.8.0 | 2026-04-26 |  |
...
| [dotenvx](https://dotenvx.com) | a better dotenv–from the creator of `dotenv` | 1.63.0 | 2026-04-25 | cat |
...
| [fzf](https://github.com/junegunn/fzf) | A command-line fuzzy finder | 0.71.0 | 2026-04-04 | skim |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.111.1 | 2026-04-22 |  |
...
| [hurl](https://hurl.dev) | Hurl, run and test HTTP requests with plain text. | 8.0.0 | 2026-04-23 |  |
...
| [layerleak](https://github.com/Brumbelow/layerleak) | layerleak the Docker Hub Secret Scanner | 2.0.0 | 2026-04-25 |  |
...
| [llmfit](https://github.com/AlexsJones/llmfit) | 206 models. 30 providers. One command to find what runs on your hardware. | 0.9.15 | 2026-04-26 |  |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.21.2 | 2026-04-24 |  |
...
| [starship](https://github.com/starship/starship) | The minimal, blazing-fast, and infinitely customizable prompt for any shell! | 1.25.0 | 2026-04-19 | powerline-go |
| [superfile](https://superfile.dev) | Pretty fancy and modern terminal file manager | 1.5.0 | 2026-01-13 | yazi, ranger |
| [surge](https://github.com/surge-downloader/surge) | Blazing fast TUI download manager built in Go for power users | 0.8.3 | 2026-04-25 |  |
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.43.0 | 2026-04-22 |  |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.11.7 | 2026-04-17 | pip, pdm, poetry, rye |
...
| [worktrunk](https://github.com/max-sixty/worktrunk) | Worktrunk is a CLI for Git worktree management, designed for parallel AI agent workflows | 0.44.0 | 2026-04-22 |  |
...
| [zellij](https://github.com/zellij-org/zellij) | Blazing fast terminal file manager written in Rust, based on async I/O. | 0.44.1 | 2026-04-07 | tmux |
...
_last updated: 2026-04-26 06:21:43 (utc)_
