...
|----- |------------ |-------- |-------- |------------- |
| [atuin](https://atuin.sh) | Magical shell history | 18.13.5 | 2026-03-25 | mcfly, hishtory |
...
| [broot](https://dystroy.org/broot) | A new way to see and navigate directory trees | 1.56.1 | 2026-03-20 |  |
...
| [clang-tools](https://github.com/llvm/llvm-project) | --- | 22.1.2 | 2026-03-25 |  |
| [clangd](https://github.com/clangd/clangd) | clangd language server | 22.1.0 | 2026-03-01 |  |
| [cmake](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 4.3.0 | 2026-03-18 |  |
| [cmake3](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 3.31.11 | 2026-01-27 |  |
| [code-server](https://coder.com) | VS Code in the browser | 4.112.0 | 2026-03-20 |  |
...
| [dasel](https://github.com/TomWright/dasel) | Select, put and delete data from JSON, TOML, YAML, XML and CSV files with a single tool. Supports conversion between formats and can be used as a Go package. | 3.4.0 | 2026-03-20 |  |
...
| [delta](https://github.com/dandavison/delta) | A syntax-highlighting pager for git, diff, grep, and blame output | 0.19.1 | 2026-03-23 |  |
...
| [difi](https://github.com/oug-t/difi) | Review and refine Git diffs before you push | 0.1.9 | 2026-03-23 | diff, difftastic |
...
| [dotenvx](https://dotenvx.com) | a better dotenv–from the creator of `dotenv` | 1.57.2 | 2026-03-23 | cat |
...
| [gdu](https://github.com/dundee/gdu) | Fast disk usage analyzer with console interface written in Go | 5.34.4 | 2026-03-22 | du, dust, ncdu |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.110.0 | 2026-03-20 |  |
...
| [just](https://github.com/casey/just) | Just a command runner | 1.48.0 | 2026-03-24 | make, dotree, task |
...
| [llmfit](https://github.com/AlexsJones/llmfit) | 206 models. 30 providers. One command to find what runs on your hardware. | 0.8.4 | 2026-03-23 |  |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.18.3 | 2026-03-26 |  |
...
| [surge](https://github.com/surge-downloader/surge) | Blazing fast TUI download manager built in Go for power users | 0.7.5 | 2026-03-21 |  |
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.42.3 | 2026-03-20 |  |
...
| [td](https://github.com/marcus/td) | A minimalist CLI for tracking tasks across AI coding sessions. | 0.43.0 | 2026-03-24 |  |
| [tealdeer](https://github.com/dbrgn/tealdeer) | A very fast implementation of tldr in Rust. | 1.8.1 | 2025-11-12 | tldr, tlrc |
| [television](https://github.com/alexpasmantier/television) | The revolution will (not) be televised | 0.15.4 | 2026-03-22 | fzf |
...
| [topgrade](https://github.com/topgrade-rs/topgrade) | Upgrade all the things | 17.1.0 | 2026-03-11 |  |
...
| [trufflehog](https://trufflesecurity.com) | Find, verify, and analyze leaked credentials | 3.94.1 | 2026-03-25 |  |
...
| [usql](https://github.com/xo/usql) | Universal command-line interface for SQL databases | 0.21.3 | 2026-03-26 |  |
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.11.1 | 2026-03-25 | pip, pdm, poetry, rye |
...
| [worktrunk](https://github.com/max-sixty/worktrunk) | Worktrunk is a CLI for Git worktree management, designed for parallel AI agent workflows | 0.32.0 | 2026-03-26 |  |
...
| [yq](https://github.com/mikefarah/yq) | yq is a portable command-line YAML, JSON, XML, CSV, TOML and properties processor | 4.52.5 | 2026-03-26 |  |
| [zellij](https://github.com/zellij-org/zellij) | Blazing fast terminal file manager written in Rust, based on async I/O. | 0.44.0 | 2026-03-23 | tmux |
...
_last updated: 2026-03-26 05:50:47 (utc)_
