...
| [bottom](https://github.com/ClementTsang/bottom) | Yet another cross-platform graphical process/system monitor. | 0.14.1 | 2026-06-22 | top, htop |
...
| [code-server](https://coder.com) | VS Code in the browser | 4.125.0 | 2026-06-18 |  |
...
| [dblab](https://github.com/danvergara/dblab) | The database client every command line junkie deserves. | 0.42.0 | 2026-06-22 | lazysql, usql |
| [delta](https://github.com/dandavison/delta) | A syntax-highlighting pager for git, diff, grep, and blame output | 0.19.2 | 2026-03-29 |  |
| [devbox](https://github.com/jetify-com/devbox) | Instant, easy, and predictable development environments | 0.17.4 | 2026-06-22 |  |
| [difftastic](https://github.com/Wilfred/difftastic) | a structural diff that understands syntax | 0.69.0 | 2026-05-01 | diff |
| [difi](https://github.com/oug-t/difi) | Review and refine Git diffs before you push | 0.2.6 | 2026-05-09 | diff, difftastic |
...
| [duplo](https://github.com/dlidstrom/Duplo) | Duplicates finder for various source code formats. | 2.3.2 | 2026-06-10 |  |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.114.0 | 2026-06-06 |  |
...
| [llmfit](https://github.com/AlexsJones/llmfit) | 206 models. 30 providers. One command to find what runs on your hardware. | 0.9.31 | 2026-06-10 |  |
| [mcfly](https://github.com/cantino/mcfly) | Fly through your shell history. Great Scott! | 0.9.4 | 2025-12-25 | atuin, hishtory |
| [mdr](https://github.com/CleverCloud/mdr) | a very light rust based markdown reader with support of mermaid (web, native, TUI). vibe coded | 0.3.1 | 2026-06-22 |  |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.30.10 | 2026-06-18 |  |
...
| [pmd](https://pmd.github.io) | An extensible multilanguage static code analyzer. | 7.26.0-SNAPSHOT | 2026-05-29 |  |
...
| [podman-tui](https://github.com/containers/podman-tui) | Podman Terminal UI | 1.11.2 | 2026-06-20 |  |
...
| [qemu](https://www.qemu.org) | A generic and open source machine emulator and virtualizer. | 11.0.1 | 2026-05-25 |  |
...
| [runme](https://github.com/stateful/runme) | DevOps Workflows Built with Markdown | 3.16.15 | 2026-06-23 |  |
| [rustcat](https://github.com/quantumsheep/sshs) | Rustcat(rcat) - The modern Port listener and Reverse shell | 3.0.0 | 2022-08-15 |  |
| [sbom-utility](https://github.com/CycloneDX/sbom-utility) | Utility that provides an API platform for validating, querying and managing BOM data | 0.19.1 | 2026-06-01 |  |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.11.23 | 2026-06-20 | pip, pdm, poetry, rye |
...
| [worktrunk](https://github.com/max-sixty/worktrunk) | Worktrunk is a CLI for Git worktree management, designed for parallel AI agent workflows | 0.61.0 | 2026-06-22 |  |
...
_last updated: 2026-06-23 05:04:33 (utc)_
