...
| [betterleaks](https://github.com/betterleaks/betterleaks) | A Better Secrets Scanner built for configurability and speed | 1.7.0 | 2026-07-23 | gitleaks |
...
| [bottom](https://github.com/ClementTsang/bottom) | Yet another cross-platform graphical process/system monitor. | 0.14.6 | 2026-07-20 | top, htop |
...
| [cmake](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 4.4.0 | 2026-07-10 |  |
| [cmake3](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 3.31.12 | 2026-04-21 |  |
| [code-server](https://coder.com) | VS Code in the browser | 4.130.0 | 2026-07-24 |  |
...
| [croc](https://github.com/schollz/croc) | Easily and securely send things from one computer to another | 10.6.0 | 2026-07-23 |  |
...
| [dblab](https://github.com/danvergara/dblab) | The database client every command line junkie deserves. | 0.46.0 | 2026-07-21 | lazysql, usql |
...
| [dotenvx](https://dotenvx.com) | a better dotenv–from the creator of `dotenv` | 2.18.0 | 2026-07-25 | cat |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.116.0 | 2026-07-16 |  |
...
| [lazygit](https://github.com/jesseduffield/lazygit) | simple terminal UI for git commands | 0.63.1 | 2026-07-15 |  |
...
| [llmfit](https://github.com/AlexsJones/llmfit) | 206 models. 30 providers. One command to find what runs on your hardware. | 1.1.6 | 2026-07-21 |  |
...
| [mergiraf](https://mergiraf.org) | A syntax-aware git merge driver for a growing collection of programming languages and file formats. | 0.18.0 | 2026-07-15 |  |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.32.3 | 2026-07-23 |  |
...
| [podcheck](https://github.com/sudo-kraken/podcheck) | CLI tool to automate podman image updates. Selective, notifications, autoprune, no pre-pulling. | 1.3.0 | 2026-07-17 | dockcheck |
...
| [python](https://python.org) | Python is a programming language that lets you work quickly and integrate systems more effectively. | 3.14.6 | 2026-06-10 |  |
| [qemu](https://www.qemu.org) | A generic and open source machine emulator and virtualizer. | 11.0.3 | 2026-07-25 |  |
| [rainfrog](https://crates.io/crates/rainfrog) | a database management tui for postgres | 0.4.1 | 2026-07-25 |  |
...
| [runme](https://github.com/stateful/runme) | DevOps Workflows Built with Markdown | 3.17.2 | 2026-07-14 |  |
...
| [sidecar](https://github.com/marcus/sidecar) | Use sidecar next to CLI agents for diffs, file trees, conversation history, and task management with td | 0.87.1 | 2026-07-25 |  |
...
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.49.0 | 2026-07-21 |  |
...
| [td](https://github.com/marcus/td) | A minimalist CLI for tracking tasks across AI coding sessions. | 0.53.0 | 2026-07-25 |  |
...
| [trufflehog](https://trufflesecurity.com) | Find, verify, and analyze leaked credentials | 3.96.0 | 2026-07-25 |  |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.11.32 | 2026-07-24 | pip, pdm, poetry, rye |
...
| [worktrunk](https://github.com/max-sixty/worktrunk) | Worktrunk is a CLI for Git worktree management, designed for parallel AI agent workflows | 0.69.2 | 2026-07-25 |  |
...
_last updated: 2026-07-25 10:15:02 (utc)_
