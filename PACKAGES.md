...
|----- |------------ |-------- |-------- |------------- |
| [atuin](https://atuin.sh) | Magical shell history | 18.6.1 | 2025-05-09 | mcfly, hishtory |
...
| [broot](https://dystroy.org/broot) | A new way to see and navigate directory trees | 1.47.0 | 2025-06-27 |  |
...
| [carapace](https://carapace.sh) | multi-shell multi-command argument completer | 1.3.3 | 2025-06-20 |  |
...
| [clang-tools](https://github.com/llvm/llvm-project) | --- | 20.1.8 | 2025-07-09 |  |
...
| [code-server](https://coder.com) | VS Code in the browser | 4.101.2 | 2025-06-26 |  |
| [codon](https://github.com/exaloop/codon) | A high-performance, zero-overhead, extensible Python compiler using LLVM | 0.19.0 | 2025-06-27 |  |
...
| [dotenvx](https://dotenvx.com) | a better dotenv–from the creator of `dotenv` | 1.47.5 | 2025-07-12 | cat |
...
| [eza](https://github.com/eza-community/eza) | A modern alternative to ls | 0.22.1 | 2025-07-13 | ls, lsd |
...
| [fzf](https://github.com/junegunn/fzf) | A command-line fuzzy finder | 0.64.0 | 2025-07-06 | skim |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.95.0 | 2025-07-03 |  |
...
| [just](https://github.com/casey/just) | Just a command runner | 1.41.0 | 2025-07-01 | make, dotree, task |
| [k9s](https://github.com/derailed/k9s) | Kubernetes CLI To Manage Your Clusters In Style! | 0.50.7 | 2025-07-06 |  |
...
| [lazysql](https://github.com/jorgerojas26/lazysql) | A cross-platform TUI database management tool written in Go. | 0.3.8 | 2025-07-04 |  |
...
| [mergiraf](https://mergiraf.org) | A syntax-aware git merge driver for a growing collection of programming languages and file formats. | 0.12.1 | 2025-07-11 |  |
| [miniserve](https://github.com/svenstaro/miniserve) | For when you really just want to serve some files over HTTP right now! | 0.31.0 | 2025-06-28 | simple-http-server, see, binserve, http |
| [mold](https://github.com/rui314/mold) | Mold: A Modern Linker | 2.40.2 | 2025-07-12 | ld, lld, gold |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.9.6 | 2025-07-08 |  |
...
| [rainfrog](https://crates.io/crates/rainfrog) | a database management tui for postgres | 0.3.3 | 2025-07-11 |  |
...
| [runme](https://github.com/stateful/runme) | DevOps Workflows Built with Markdown | 3.14.3 | 2025-07-09 |  |
...
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.28.0 | 2025-07-03 |  |
...
| [television](https://github.com/alexpasmantier/television) | The revolution will (not) be televised | 0.12.3 | 2025-07-13 | fzf |
...
| [usql](https://github.com/xo/usql) | Universal command-line interface for SQL databases | 0.19.24 | 2025-05-20 |  |
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.7.20 | 2025-07-10 | pip, pdm, poetry, rye |
...
| [yq](https://github.com/mikefarah/yq) | yq is a portable command-line YAML, JSON, XML, CSV, TOML and properties processor | 4.46.1 | 2025-07-10 |  |
...
_last updated: 2025-07-13 08:58:15 (utc)_
