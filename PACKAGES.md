...
| [devbox](https://github.com/jetify-com/devbox) | Instant, easy, and predictable development environments | 0.13.0 | 2024-09-18 |  |
...
| [eza](https://github.com/eza-community/eza) | A modern alternative to ls | 0.19.4 | 2024-09-18 | ls, lsd |
...
| [gitleaks](https://github.com/gitleaks/gitleaks) | Protect and discover secrets using Gitleaks | 8.19.2 | 2024-09-16 |  |
| [glow](https://github.com/charmbracelet/glow) | Render markdown on the CLI, with pizzazz! | 2.0.0 | 2024-08-23 |  |
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.80.1 | 2024-09-11 |  |
...
| [hwatch](https://github.com/blacknon/hwatch) | A modern alternative to the watch command, records the differences in execution results and can check this differences at after. | 0.3.15 | 2024-06-18 | watch, viddy |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.3.11 | 2024-09-18 |  |
...
| [runme](https://github.com/stateful/runme) | DevOps Workflows Built with Markdown | 3.7.1 | 2024-09-10 |  |
...
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.12.2 | 2024-09-11 |  |
| [tailspin](https://github.com/bensadeh/tailspin) | A log file highlighter | 3.0.2 | 2024-08-17 |  |
| [task](https://github.com/go-task/task) | A task runner / simpler Make alternative written in Go | 3.39.0 | 2024-09-08 | make, dotree, just |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.4.12 | 2024-09-18 | pip, pdm, poetry, rye |
| [vhs](https://github.com/charmbracelet/vhs) | Your CLI home video recorder | 0.8.0 | 2024-09-06 |  |
| [viddy](https://github.com/sachaos/viddy) | A modern watch command. Time machine and pager etc. | 1.1.2 | 2024-09-05 | watch, hwatch |
...
| [zoxide](https://github.com/ajeetdsouza/zoxide) | A smarter cd command. Supports all major shells. | 0.9.5 | 2024-09-13 |  |
...
_last updated: 2024-09-18 16:47:53 (utc)_
