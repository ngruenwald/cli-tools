...
| [bottom](https://github.com/ClementTsang/bottom) | Yet another cross-platform graphical process/system monitor. | 0.11.4 | 2025-11-17 | top, htop |
| [broot](https://dystroy.org/broot) | A new way to see and navigate directory trees | 1.53.0 | 2025-11-08 |  |
...
| [clang-tools](https://github.com/llvm/llvm-project) | --- | 21.1.7 | 2025-12-02 |  |
| [clangd](https://github.com/clangd/clangd) | clangd language server | 21.1.0 | 2025-08-27 |  |
| [cmake](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 4.2.0 | 2025-11-19 |  |
| [cmake3](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 3.31.10 | 2025-11-18 |  |
| [code-server](https://coder.com) | VS Code in the browser | 4.106.3 | 2025-12-02 |  |
| [codelldb-vsix](https://github.com/vadimcn/codelldb) | A native debugger extension for VSCode based on LLDB | 1.12.0 | 2025-12-01 |  |
...
| [dotenvx](https://dotenvx.com) | a better dotenv–from the creator of `dotenv` | 1.51.1 | 2025-11-04 | cat |
...
| [dysk](https://dystroy.org/dysk) | A linux utility to get information on filesystems, like df but better | 3.5.0 | 2025-12-02 | df, duf |
...
| [git](https://git-scm.com) | Git is a free and open source distributed version control system designed to handle everything from small to very large projects with speed and efficiency. | 2.52.0 | 2025-11-17 |  |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.104.1 | 2025-11-24 |  |
...
| [just](https://github.com/casey/just) | Just a command runner | 1.43.1 | 2025-11-13 | make, dotree, task |
...
| [lazydocker](https://github.com/jesseduffield/lazydocker) | The lazier way to manage everything docker | 0.24.2 | 2025-11-14 |  |
| [lazygit](https://github.com/jesseduffield/lazygit) | simple terminal UI for git commands | 0.56.0 | 2025-11-02 |  |
| [lazyjournal](https://github.com/Lifailon/lazyjournal) | A TUI for reading logs from journald, auditd, file system, Docker containers, ... | 0.8.2 | 2025-12-01 |  |
| [lazysql](https://github.com/jorgerojas26/lazysql) | A cross-platform TUI database management tool written in Go. | 0.4.3 | 2025-10-27 |  |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.13.1 | 2025-12-02 |  |
...
| [python](https://python.org) | Python is a programming language that lets you work quickly and integrate systems more effectively. | 3.14.1 | 2025-12-03 |  |
| [qemu](https://www.qemu.org) | A generic and open source machine emulator and virtualizer. | 10.1.2 | 2025-10-20 |  |
| [rainfrog](https://crates.io/crates/rainfrog) | a database management tui for postgres | 0.3.10 | 2025-11-08 |  |
| [regctl](https://regclient.org) | Docker and OCI Registry Client in Go and tooling using those libraries. | 0.11.0 | 2025-12-02 |  |
...
| [sonarscanner](https://docs.sonarsource.com/sonarqube/latest/analyzing-source-code/scanners/sonarscanner/) | The SonarScanner CLI is the scanner to use when there is no specific scanner for your build system. | 8.0.0.6341 | 2025-12-03 |  |
...
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.38.0 | 2025-11-17 |  |
...
| [television](https://github.com/alexpasmantier/television) | The revolution will (not) be televised | 0.13.12 | 2025-11-28 | fzf |
...
| [tokei](https://github.com/XAMPPRocky/tokei) | Count your code, quickly. | 13.0.0 | 2025-11-25 | sloc, scc |
...
| [trufflehog](https://trufflesecurity.com) | Find, verify, and analyze leaked credentials | 3.91.2 | 2025-12-02 |  |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.9.15 | 2025-12-03 | pip, pdm, poetry, rye |
...
| [yq](https://github.com/mikefarah/yq) | yq is a portable command-line YAML, JSON, XML, CSV, TOML and properties processor | 4.49.2 | 2025-11-25 |  |
...
_last updated: 2025-12-03 18:38:31 (utc)_
