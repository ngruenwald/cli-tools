...
| [betterleaks](https://github.com/betterleaks/betterleaks) | A Better Secrets Scanner built for configurability and speed | 1.4.0 | 2026-06-02 | gitleaks |
...
| [carapace](https://carapace.sh) | multi-shell multi-command argument completer | 1.7.0 | 2026-05-29 |  |
...
| [clang-tools](https://github.com/llvm/llvm-project) | --- | 22.1.7 | 2026-06-02 |  |
| [clangd](https://github.com/clangd/clangd) | clangd language server | 22.1.6 | 2026-05-29 |  |
| [cmake](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 4.3.3 | 2026-05-22 |  |
| [cmake3](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 3.31.12 | 2026-04-21 |  |
| [code-server](https://coder.com) | VS Code in the browser | 4.122.1 | 2026-06-02 |  |
...
| [dotenvx](https://dotenvx.com) | a better dotenv–from the creator of `dotenv` | 1.71.0 | 2026-06-02 | cat |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.112.0 | 2026-05-01 |  |
...
| [lazygit](https://github.com/jesseduffield/lazygit) | simple terminal UI for git commands | 0.62.1 | 2026-05-28 |  |
...
| [lazysql](https://github.com/jorgerojas26/lazysql) | A cross-platform TUI database management tool written in Go. | 0.5.3 | 2026-06-02 |  |
...
| [llmfit](https://github.com/AlexsJones/llmfit) | 206 models. 30 providers. One command to find what runs on your hardware. | 0.9.30 | 2026-06-01 |  |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.30.2 | 2026-06-03 |  |
...
| [podcheck](https://github.com/sudo-kraken/podcheck) | CLI tool to automate podman image updates. Selective, notifications, autoprune, no pre-pulling. | 1.2.1 | 2026-05-06 | dockcheck |
...
| [surge](https://github.com/surge-downloader/surge) | Blazing fast TUI download manager built in Go for power users | 0.8.6 | 2026-05-11 |  |
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.45.0 | 2026-06-03 |  |
...
| [topgrade](https://github.com/topgrade-rs/topgrade) | Upgrade all the things | 17.5.1 | 2026-05-21 |  |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.11.18 | 2026-06-02 | pip, pdm, poetry, rye |
...
| [worktrunk](https://github.com/max-sixty/worktrunk) | Worktrunk is a CLI for Git worktree management, designed for parallel AI agent workflows | 0.56.0 | 2026-06-03 |  |
...
| [yq](https://github.com/mikefarah/yq) | yq is a portable command-line YAML, JSON, XML, CSV, TOML and properties processor | 4.53.2 | 2026-04-17 |  |
...
_last updated: 2026-06-03 05:19:59 (utc)_
