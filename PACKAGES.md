...
| [broot](https://dystroy.org/broot) | A new way to see and navigate directory trees | 1.51.0 | 2025-10-05 |  |
...
| [carapace](https://carapace.sh) | multi-shell multi-command argument completer | 1.5.3 | 2025-10-11 |  |
...
| [clang-tools](https://github.com/llvm/llvm-project) | --- | 21.1.3 | 2025-10-07 |  |
...
| [code-server](https://coder.com) | VS Code in the browser | 4.104.3 | 2025-10-07 |  |
...
| [dotenvx](https://dotenvx.com) | a better dotenv–from the creator of `dotenv` | 1.51.0 | 2025-09-24 | cat |
...
| [fzf](https://github.com/junegunn/fzf) | A command-line fuzzy finder | 0.66.0 | 2025-10-12 | skim |
...
| [git](https://git-scm.com) | Git is a free and open source distributed version control system designed to handle everything from small to very large projects with speed and efficiency. | 2.51.1 | 2025-10-15 |  |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.101.1 | 2025-10-16 |  |
...
| [k9s](https://github.com/derailed/k9s) | Kubernetes CLI To Manage Your Clusters In Style! | 0.50.15 | 2025-10-07 |  |
...
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.12.5 | 2025-10-11 |  |
...
| [qemu](https://www.qemu.org) | A generic and open source machine emulator and virtualizer. | 10.1.1 | 2025-10-08 |  |
| [rainfrog](https://crates.io/crates/rainfrog) | a database management tui for postgres | 0.3.8 | 2025-10-12 |  |
| [regctl](https://regclient.org) | Docker and OCI Registry Client in Go and tooling using those libraries. | 0.9.2 | 2025-08-31 |  |
| [ripgrep](https://github.com/BurntSushi/ripgrep) | ripgrep recursively searches directories for a regex pattern while respecting your gitignore | 15.0.0 | 2025-10-16 | grep |
...
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.34.2 | 2025-10-16 |  |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.9.3 | 2025-10-15 | pip, pdm, poetry, rye |
...
_last updated: 2025-10-16 15:59:56 (utc)_
