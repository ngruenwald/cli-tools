...
| [cmake](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 3.31.0 | 2024-11-06 |  |
...
| [devbox](https://github.com/jetify-com/devbox) | Instant, easy, and predictable development environments | 0.13.6 | 2024-10-29 |  |
| [difftastic](https://github.com/Wilfred/difftastic) | a structural diff that understands syntax | 0.61.0 | 2024-10-24 | diff |
...
| [eza](https://github.com/eza-community/eza) | A modern alternative to ls | 0.20.7 | 2024-11-07 | ls, lsd |
...
| [fzf](https://github.com/junegunn/fzf) | A command-line fuzzy finder | 0.56.2 | 2024-11-11 | skim |
...
| [grype](https://github.com/anchore/grype) | A vulnerability scanner for container images and filesystems | 0.84.0 | 2024-11-05 |  |
...
| [hwatch](https://github.com/blacknon/hwatch) | A modern alternative to the watch command, records the differences in execution results and can check this differences at after. | 0.3.17 | 2024-11-13 | watch, viddy |
...
| [k9s](https://github.com/derailed/k9s) | Kubernetes CLI To Manage Your Clusters In Style! | 0.32.6 | 2024-11-10 |  |
...
| [nushell](https://nushell.sh) | A new type of shell | 0.100.0 | 2024-11-13 | bash, zsh, fish, powershell |
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.4.1 | 2024-11-09 |  |
...
| [syft](https://github.com/anchore/syft) | CLI tool and library for generating a Software Bill of Materials from container images and filesystems | 1.16.0 | 2024-11-05 |  |
| [tailspin](https://github.com/bensadeh/tailspin) | A log file highlighter | 4.0.0 | 2024-10-13 |  |
| [task](https://github.com/go-task/task) | A task runner / simpler Make alternative written in Go | 3.40.0 | 2024-11-06 | make, dotree, just |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.5.1 | 2024-11-09 | pip, pdm, poetry, rye |
...
| [zellij](https://github.com/zellij-org/zellij) | Blazing fast terminal file manager written in Rust, based on async I/O. | 0.41.1 | 2024-11-04 | tmux |
...
_last updated: 2024-11-13 17:26:01 (utc)_
