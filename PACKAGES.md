...
| [bottom](https://github.com/ClementTsang/bottom) | Yet another cross-platform graphical process/system monitor. | 0.14.3 | 2026-07-02 | top, htop |
| [broot](https://dystroy.org/broot) | A new way to see and navigate directory trees | 1.57.0 | 2026-06-01 |  |
...
| [cmake](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 4.3.4 | 2026-06-18 |  |
| [cmake3](https://github.com/Kitware/CMake) | CMake, the cross-platform, open-source build system. | 3.31.12 | 2026-04-21 |  |
| [code-server](https://coder.com) | VS Code in the browser | 4.127.0 | 2026-07-02 |  |
...
| [dblab](https://github.com/danvergara/dblab) | The database client every command line junkie deserves. | 0.43.0 | 2026-07-05 | lazysql, usql |
...
| [difi](https://github.com/oug-t/difi) | Review and refine Git diffs before you push | 0.2.9 | 2026-06-28 | diff, difftastic |
...
| [dotenvx](https://dotenvx.com) | a better dotenv–from the creator of `dotenv` | 2.1.4 | 2026-07-03 | cat |
...
| [duplo](https://github.com/dlidstrom/Duplo) | Duplicates finder for various source code formats. | 2.3.8 | 2026-06-29 |  |
...
| [herdr](https://herdr.dev) | agent multiplexer that lives in your terminal. | 0.7.1 | 2026-06-27 |  |
...
| [just](https://github.com/casey/just) | Just a command runner | 1.55.1 | 2026-07-01 | make, dotree, task |
...
| [lazygit](https://github.com/jesseduffield/lazygit) | simple terminal UI for git commands | 0.63.0 | 2026-07-05 |  |
...
| [llmfit](https://github.com/AlexsJones/llmfit) | 206 models. 30 providers. One command to find what runs on your hardware. | 0.9.38 | 2026-07-06 |  |
...
| [nushell](https://nushell.sh) | A new type of shell | 0.114.0 | 2026-07-05 | bash, zsh, fish, powershell |
| [ollama](https://github.com/ollama/ollama) | Get up and running with Llama 3.1, Mistral, Gemma 2, and other large language models. | 0.31.1 | 2026-07-01 |  |
...
| [podcheck](https://github.com/sudo-kraken/podcheck) | CLI tool to automate podman image updates. Selective, notifications, autoprune, no pre-pulling. | 1.2.4 | 2026-06-18 | dockcheck |
...
| [qemu](https://www.qemu.org) | A generic and open source machine emulator and virtualizer. | 11.0.2 | 2026-06-25 |  |
| [rainfrog](https://crates.io/crates/rainfrog) | a database management tui for postgres | 0.3.19 | 2026-06-18 |  |
...
| [runme](https://github.com/stateful/runme) | DevOps Workflows Built with Markdown | 3.16.18 | 2026-07-02 |  |
...
| [sidecar](https://github.com/marcus/sidecar) | Use sidecar next to CLI agents for diffs, file trees, conversation history, and task management with td | 0.86.0 | 2026-06-18 |  |
...
| [sops](https://getsops.io) | Simple and flexible tool for managing secrets | 3.13.2 | 2026-07-01 | git-crypt |
...
| [topgrade](https://github.com/topgrade-rs/topgrade) | Upgrade all the things | 17.6.2 | 2026-06-20 |  |
...
| [trufflehog](https://trufflesecurity.com) | Find, verify, and analyze leaked credentials | 3.95.8 | 2026-07-03 |  |
...
| [uv](https://github.com/astral-sh/uv) | An extremely fast Python package and project manager, written in Rust. | 0.11.26 | 2026-07-01 | pip, pdm, poetry, rye |
...
_last updated: 2026-07-06 05:12:40 (utc)_
